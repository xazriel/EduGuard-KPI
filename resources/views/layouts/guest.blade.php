        ...
        <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 relative z-10">
            <div class="mb-8">
                <a href="/" class="flex items-center gap-3">
                    ...
                    <div>
                        <span class="font-extrabold text-slate-800 text-xl tracking-tight block">Pelanggaran Siswa</span>
                        <span class="text-xs text-indigo-400 font-semibold tracking-wider uppercase block">Dashboard Monitoring</span>
                    </div>
                </a>
            </div>
